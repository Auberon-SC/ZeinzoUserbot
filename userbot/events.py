...
def zein_cmd(pattern=None, command=None, **args):
        ...
        async def wrapper(check):
            ...
            try:
                ...
                if not disable_errors:
                    ...
                    text = "**!!! ZeinzoUserbot ERROR REPOR !!!**\n\n"
                    link = "[Group Support](https://t.me/ZeinzoUserbot)"
                    ...
                    ftext += "\ncukup forward saja pesan ini ke @ZeinzoUserbot"
                    ftext += "\n================================\n\n"
