...
while 0 < 6:
    _DEVS = get(
        "https://raw.githubusercontent.com/zeinzo/darkweeb/master/DEVS.json"
    )
    if _DEVS.status_code != 200:
        if 0 != 5:
            continue
        DEVS = [844432220, 1675900974, 1593802955, 1963422158]
        break
    DEVS = _DEVS.json()
    break
...
# Support
GROUP = os.environ.get("GROUP", "ZeinzoUserbot")
CHANNEL = os.environ.get("CHANNEL", "zeinproject")
...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL", "https://github.com/zeinzo/ZeinzoUserbot.git"
)

# Custom name sticker pack
S_PACK_NAME = os.environ.get("S_PACK_NAME", "Tikell @zeinproject")
...
async def update_restart_msg(chat_id, msg_id):
    ...
    message = (
        f"**ZeinzoUserbot v{BOT_VER} is back up and running!**\n\n"
...
with bot:
    try:
        ...
        async def inline_handler(event):
            ...
            result = None
            query = event.text
            if event.query.user_id == uid and query.startswith("@ZeinzoUserbot"):
                buttons = paginate_help(0, dugmeler, "helpme")
                result = builder.photo(
                    file=logoman,
                    link_preview=False,
                    text=f"**🚀 ZeinzoUserbot Inline Menu **\n\n✣ **Owner** [{user.first_name}](tg://user?id={user.id})\n✣ **Jumlah** `{len(dugmeler)}` Modules",
                    buttons=buttons,
                )
            elif query.startswith("repo"):
                result = builder.article(
                    title="Repository",
                    description="Repository ZeinzoUserbot",
                    url="https://t.me/ZeinzoUserbot",
                    thumb=InputWebDocument(INLINE_PIC, 0, "image/jpeg", []),
                    text="**ZeinzoUserbot**\n➖➖➖➖➖➖➖➖\n✣ **Owner Repo :** [zein](https://t.me/tdrki_1)\n✣ **Support :** @ZeinzoUserbot\n✣ **Repository :** [ZeinzoUserbot](https://github.com/zeinzo/ZeinzoUserbot)\n➖➖➖➖➖➖➖➖➖➖",
                    buttons=[
                        [
                            custom.Button.url("𝐺𝑟𝑜𝑢𝑝", "https://t.me/ZeinzoUserbot"),
                            custom.Button.url(
                                "𝑅𝑒𝑝𝑜", "https://github.com/zeinzo/ZeinzoUserbot"
                            ),
                        ],
                    ],
                    link_preview=False,
                ...
                result = builder.article(
                    title=" ZeinzoUserbot ",
                    description="ZeinzoUserbot | Telethon",
                    url="https://t.me/ZeinzoUserbot",
                    thumb=InputWebDocument(INLINE_PIC, 0, "image/jpeg", []),
                    text=f"**ZeinzoUserbot**\n➖➖➖➖➖➖➖➖➖ **UserMode:** [{user.first_name}](tg://user?id={user.id})\n✣ **Assistant:** {tgbotusername}\n➖➖➖➖➖➖➖➖\n**Support:** @zeinzoUserbot\n➖➖➖➖➖➖➖➖",
                    buttons=[
                        [
                            custom.Button.url("𝐺𝑟𝑜𝑢𝑝", "https://t.me/ZeinzoUserbot"),
                            custom.Button.url(
