...
@bot.on(zein_cmd(outgoing=True, pattern=r"setwelcome(?: |$)(.*)"))
...
@bot.on(zein_cmd(outgoing=True, pattern=r"checkwelcome$"))
...
@bot.on(zein_cmd(outgoing=True, pattern=r"rmwelcome$"))
