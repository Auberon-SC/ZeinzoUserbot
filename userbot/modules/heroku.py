...
@zein_cmd(pattern="(get|del) var(?: |$)(\w*)")
...
@zein_cmd(pattern="set var (\w*) ([\s\S]*)")
...
CMD_HELP.update(
    {
        ...
        \n  •  **Function : **Tambahkan Variabel Baru Atau Memperbarui Variabel Setelah Menyetel Variabel ZeinzoUserbot Akan Di Restart.\
