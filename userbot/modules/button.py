...
from userbot.utils import edit_delete, zein_cmd, reply_id
...
@zein_cmd(pattern="cbutton(?:\\s|$)([\\s\\S]*)")
async def _(event):
...
@zein_cmd(pattern="ibutton(?:\\s|$)([\\s\\S]*)")
async def _(event):
...
CMD_HELP.update(
    {
        ...
        \n  •  **Examples : **`{cmd}cbutton test [google]<buttonurl:https://www.google.com> [Channel]<buttonurl:https://t.me/zeinproject:same> [Support]<buttonurl:https://t.me/ZeinzoUserbot>`\
        ...
        \n  •  **Examples : **`{cmd}ibutton test [google]<buttonurl:https://www.google.com> [Channel]<buttonurl:https://t.me/zeinproject:same> [Support]<buttonurl:https://t.me/ZeinzoUserbot>`\
    "
    }
)
