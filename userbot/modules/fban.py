...
@bot.on(zein_cmd(outgoing=True, pattern=r"(d)?fban(?: |$)(.*)"))
...
@bot.on(zein_cmd(outgoing=True, pattern=r"unfban(?: |$)(.*)"))
...
@bot.on(zein_cmd(outgoing=True, pattern=r"addf(?: |$)(.*)"))
...
@bot.on(zein_cmd(outgoing=True, pattern=r"delf$"))
...
@bot.on(zein_cmd(outgoing=True, pattern=r"listf$"))
...
@bot.on(zein_cmd(outgoing=True, pattern=r"clearf$"))
