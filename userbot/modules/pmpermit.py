...
@bot.on(zein_cmd(outgoing=True, pattern=r"notifoff$"))
...
@bot.on(zein_cmd(outgoing=True, pattern=r"notifon$"))
...
@bot.on(zein_cmd(outgoing=True, pattern=r"(?:setuju|ok)\s?(.)?"))
...
@bot.on(zein_cmd(outgoing=True, pattern=r"(?:byeee|nopm)\s?(.)?"))
...
@bot.on(zein_cmd(outgoing=True, pattern=r"block$"))
...
@bot.on(zein_cmd(outgoing=True, pattern=r"unblock$"))
...
@bot.on(zein_cmd(outgoing=True, pattern=r"(set|get|reset) pmpermit(?: |$)(\w*)"))
