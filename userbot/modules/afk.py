...
# ZeinzoUserbot < https://github.com/zeinzo/ZeinzoUserbot
# Recode by @tdrki_1
...
from userbot.utils import bash, zein_cmd, zein_handler
...
@zein_handler(incoming=True, func=lambda e: bool(e.mentioned or e.is_private))
