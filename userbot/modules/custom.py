...
from userbot.utils import edit_delete, edit_or_reply, zein_cmd, reply_id


@zein_cmd(pattern=r"\#(\S+)")
...
@zein_cmd(pattern="delcustom(?:\\s|$)([\\s\\S]*)")
async def _(event):
