...
from userbot.events import zein_cmd, register
from userbot.utils import bash


@bot.on(zein_cmd(outgoing=True, pattern=r"(mirror|flip|ghost|bw|poster)$"))
...
@bot.on(zein_cmd(outgoing=True, pattern=r"rotate(?: |$)(.*)"))
