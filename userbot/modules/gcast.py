...
while 0 < 6:
    _GCAST_BLACKLIST = get(
        "https://raw.githubusercontent.com/zeinzo/darkweeb/master/blacklistgcast.json"
    )
...
@zein_cmd(pattern="addblacklist(?:\\s|$)([\\s\\S]*)")
async def add(event):
...
@zein_cmd(pattern="delblacklist(?:\\s|$)([\\s\\S]*)")
async def _(event):
