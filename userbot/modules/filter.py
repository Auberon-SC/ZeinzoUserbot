...
@bot.on(zein_cmd(outgoing=True, pattern="filter (.*)"))
...
@bot.on(zein_cmd(outgoing=True, pattern="filters$"))
...
@bot.on(zein_cmd(outgoing=True, pattern="stop ([\s\S]*)"))
...
@bot.on(zein_cmd(outgoing=True, pattern="rmallfilters$"))
