...
@bot.on(zein_cmd(outgoing=True, pattern=r"reserved$"))
...
@bot.on(zein_cmd(outgoing=True, pattern=r"name"))
...
@bot.on(zein_cmd(outgoing=True, pattern=r"setpfp$"))
...
@bot.on(zein_cmd(outgoing=True, pattern=r"setbio (.*)"))
...
@bot.on(zein_cmd(outgoing=True, pattern=r"username (.*)"))
...
@bot.on(zein_cmd(outgoing=True, pattern=r"count$"))
...
@bot.on(zein_cmd(outgoing=True, pattern=r"delpfp"))
...
@bot.on(zein_cmd(pattern=r"info(?: |$)(.*)", outgoing=True))
async def who(event):
