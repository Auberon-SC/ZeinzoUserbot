...
@zein_handler(incoming=True, func=lambda e: e.is_private)
...
@zein_handler(incoming=True, func=lambda e: e.mentioned)
...
@zein_cmd(pattern="gruplog (on|off)$")
