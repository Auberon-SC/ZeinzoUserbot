...
from userbot.utils import edit_delete, edit_or_reply, get_user_from_event, zein_cmd


@zein_cmd(pattern="userid$")
...
@zein_cmd(pattern="inviteall ?(.*)")
async def get_users(event):
    man_ = event.text[11:]
    chat_man = man_.lower()
    restricted = ["@ZeinzoUserbot", "@ZeinzoUserbot"]
