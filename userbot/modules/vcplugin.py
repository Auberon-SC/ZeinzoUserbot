...
async def vc_play(event):
    ...
    if (
        ...
        botzein = await edit_or_reply(event, "`Searching...`")
        ...
        if search == 0:
            ...
            if hm == 0:
                ...
                try:
                    ...
                    clear_queue(chat_id)
                    await botzein.edit(f"`{ep}`")

    else:
        botzein = await edit_or_reply(event, "📥 **Sedang Mendownload**")
