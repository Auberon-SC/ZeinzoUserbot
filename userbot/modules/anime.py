...
@bot.on(zein_cmd(outgoing=True, pattern=r"anilist ?(.*)"))
...
@bot.on(zein_cmd(outgoing=True, pattern=r"anime ?(.*)"))
...
@bot.on(zein_cmd(outgoing=True, pattern=r"manga ?(.*)"))
...
@bot.on(zein_cmd(outgoing=True, pattern="a(kaizoku|kayo) ?(.*)"))
...
@bot.on(zein_cmd(outgoing=True, pattern=r"char ?(.*)"))
...
@bot.on(zein_cmd(outgoing=True, pattern="upcoming$"))
...
@bot.on(zein_cmd(outgoing=True, pattern="whatanime$"))
