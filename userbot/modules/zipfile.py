...
@bot.on(zein_cmd(outgoing=True, pattern=r"compress(?: |$)(.*)"))
async def _(event):
...
@bot.on(zein_cmd(outgoing=True, pattern=r"addzip(?: |$)(.*)"))
...
@bot.on(zein_cmd(outgoing=True, pattern=r"upzip(?: |$)(.*)"))
...
@bot.on(zein_cmd(outgoing=True, pattern=r"rmzip(?: |$)(.*)"))
